drop policy if exists "profile_likes: select own" on profile_likes;
drop policy if exists "profile_likes: insert" on profile_likes;
drop policy if exists "profile_likes: delete own" on profile_likes;
